...
(function($) {
    ...
    $.fn.jsonEditor = function(json, options) {
        ...
        var appendBtn = options.appendBtn !== undefined ? options.appendBtn : true;

        return this.each(function() {
            JSONEditor($(this), json, onchange, onpropertyclick, options.propertyElement, options.valueElement, appendBtn);
        });

    };

    function JSONEditor(target, json, onchange, onpropertyclick, propertyElement, valueElement, appendBtn) {
        var opt = {
            target: target,
            onchange: onchange,
    ...
    function construct(opt, json, root, path) {
        ...
        if ((isObject(json) || isArray(json)) && opt.appendBtn !== false) {
            if ($(opt.appendBtn) instanceof jQuery) {
                $(opt.appendBtn).off('click').click(function() {
                    addNewValue(json);
